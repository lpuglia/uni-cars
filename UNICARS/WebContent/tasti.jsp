...
name="ilGruppo" src="image/tasti/ilGruppo.png"></a><% if(session.getAttribute("operatore")!=null){%><a onMouseOver="cambia(help,'image/tasti/helpH.png')" onMouseOut="cambia(help,'image/tasti/help.png')" onClick="Popup('help/index.html')"><img
