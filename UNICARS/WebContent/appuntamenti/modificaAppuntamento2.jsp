...
<form action="" method="post">
	<table align="center">
		<tr><td align="right">Nome:</td><td><input name="nome" type="text" value="" ></td>
		<td align="right">Cognome:</td><td><input name="cognome" type="text" value=""></td></tr>
		<tr><td align="right">Data:</td><td><input name="data" type="text" value=""></td>
		<td align="right">Ora:</td><td><input name="ora" type="text" value=""></td></tr>
		<tr><td align="right">Contatto:</td><td><input name="nome" type="text" value=""></td>
		<td></td><td></td></tr>
