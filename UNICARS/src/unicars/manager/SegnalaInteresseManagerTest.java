...
public class SegnalaInteresseManagerTest {
	...
	public void testSegnalaInteresse() {
		...
		//test EC035
		assertFalse(sim.segnalaInteresse("234tyrhg", "Grieco", "12345"));
		
		//test EC036
		assertFalse(sim.segnalaInteresse(null, "Grieco", "12345"));
		...
		//test EC038
		assertFalse(sim.segnalaInteresse("Danilo", "6g4tf.55", "12345"));
		
		//EC039
		assertFalse(sim.segnalaInteresse("Danilo", null, "12345"));
		...
		//test EC041
		assertFalse(sim.segnalaInteresse("Danilo", "Grieco", "21eFRG$&£/"));
		
		//test EC042
		assertFalse(sim.segnalaInteresse("Danilo", "Grieco", null));
